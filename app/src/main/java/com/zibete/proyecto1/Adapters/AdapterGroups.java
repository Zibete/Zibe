...
public class AdapterGroups extends RecyclerView.Adapter<AdapterGroups.viewHolderAdapter> implements Filterable {
    ...
    public viewHolderAdapter onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AdapterGroups.viewHolderAdapter holder = new AdapterGroups.viewHolderAdapter(v);
...
/*
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT, widthPixels/2);

        holder.linearCardGroup.setLayoutParams(layoutParams);

 */

        holder.cardview_groups.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void goNewGroup() {
        ...
        edt_name_new_group.addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                if (edt_name_new_group.length() == 0) {
                    btn_create_new_chat.setEnabled(false);
                }
            }
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (edt_name_new_group.length() != 0) {
                    if (edt_data_new_group.length() != 0) {
        ...
        final AlertDialog alertDialog = builder.show();//type 0: incógnito, type 1: user
        btn_create_new_chat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
    ...
    public void goPublicGroup(final Groups group) {
        ...
        edt_nick.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (!(edt_nick.length() == 0)) {
                    ...
                    btn_start_chat2.setEnabled(true);
        ...
        final AlertDialog alertDialog = builder.show();//type 0: incógnito, type 1: user
        btn_start_chat1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                goGroup(v, alertDialog, group.getName(), user.getDisplayName(), 1);

            }
        });

        btn_start_chat2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                ...
                ref_group_users.child(group.getName()).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            if(name.equals(edt_nick.getText().toString())){
...
/*
                ref_group_users.child(group.getName()).orderByChild("user_name").equalTo(edt_nick.getText().toString()).addChildEventListener(new ChildEventListener() {
                    @Override
 ...
 */
    ...
    public void loadGroupCard(@NonNull final viewHolderAdapter holder, Groups group) {
        ...
        String creator = group.getID_creator();
        holder.tv_title.setText(group.getName());
        holder.tv_data_group.setText(group.getData());
        holder.tv_data_group.setSelected(true);
//        holder.tv_users.setText(String.valueOf(group.getUsers()));


        //holder.tv_number_persons.setText(group.getUsers()+"");
    ...
    public void goGroup(View v, AlertDialog alertDialog, final String groupName , String getUser, int type) {
       ...
       // data.putString("getUid", getUser);
        ...
        //MainActivity.GroupBadgeDrawable();
    ...
    public int getItemViewType(int position) {
        ...
        //if (groupsArrayList.get(position).getCategory() == PUBLIC_GROUP){
            return PUBLIC_GROUP;
        //}
    }
