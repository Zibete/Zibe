    ...
    Box(
        ...
        SnackbarHost(hostState = hostState) { data ->
            ...
            val (iconColor, iconRes) = when (type) {
                ...
                ZibeSnackType.WARNING -> zibeColors.zibeYellow to R.drawable.ic_warning_24 // ⚠️
                ZibeSnackType.INFO    -> zibeColors.zibeBlue to R.drawable.ic_info_24    // ℹ️
            }
