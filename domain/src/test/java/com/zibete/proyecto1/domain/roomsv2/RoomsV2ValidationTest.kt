...
class RoomsV2ValidationTest {
    ...
    @Test
    fun `reply target message id must be path safe`() {
        assertNull(RoomsV2Validation.validateMessageId("msg_opaque-001"))
        assertNotNull(RoomsV2Validation.validateMessageId("msg/bad"))
    }
}
