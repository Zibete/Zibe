...
object Constants {
    ...
    object UiTags {
        ...
        const val PROFILE_PAGER = "profile_pager"
        const val CHAT_SCREEN = "chat_screen"
        const val CHAT_TOP_BAR = "chat_top_bar"
        const val CHAT_TOP_BAR_OVERFLOW = "chat_top_bar_overflow"
        ...
        const val DISCOVER_FILTER_ACTIONS = "discover_filter_actions"
        const val DISCOVER_FILTER_CLEAR = "discover_filter_clear"
        const val DISCOVER_AGE_RANGE = "discover_age_range"
